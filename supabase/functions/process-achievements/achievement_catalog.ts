...
export const ALL_ACHIEVEMENTS: CatalogEntry[] = [
  ...
  },
  {
    ...
    wave: 2,
    tiers: [
      { at: 15, rewardPoints: 20, roman: "I", goal: "15 micro-logs" },
      { at: 40, rewardPoints: 45, roman: "II", goal: "40 micro-logs" },
      { at: 100, rewardPoints: 95, roman: "III", goal: "100 micro-logs" },
    ],
  },
  {
    key: "rear_guard",
    ...
    wave: 2,
    tiers: [
      { at: 5, rewardPoints: 22, roman: "I", goal: "5 logs from the back half" },
      { at: 18, rewardPoints: 55, roman: "II", goal: "18 logs" },
      { at: 45, rewardPoints: 120, roman: "III", goal: "45 logs" },
    ],
  },
  {
    key: "penny_stack",
    ...
    wave: 2,
    tiers: [
      { at: 150, rewardPoints: 25, roman: "I", goal: "150 pts from small logs" },
      { at: 450, rewardPoints: 60, roman: "II", goal: "450 pts" },
      { at: 1200, rewardPoints: 140, roman: "III", goal: "1200 pts" },
    ],
  },

-- Idle wake: members who have *never* logged a real workout had last_ts forced to
-- epoch → absurd "days idle" (e.g. 20000+). Skip wake until they have at least
-- one real log; cap days in payload for sanity.
--
-- Run after 18_idle_wake_real_logs_only.sql
...
begin
  ...
  loop
    ...
    -- Never logged a real workout → not "idle since 1970"; skip until they log once.

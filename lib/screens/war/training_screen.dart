...
/// instant and costs ⚡; deploying trained troops in battle is free.
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  Text(
                    '💪 Log a workout to earn ⚡ — then turn sweat into soldiers.',
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [JarsColors.gold.withValues(alpha: 0.08), JarsColors.surface],
        ),
      ...
      child: Column(
        ...
        children: [
            ...
            Column(children: [
              Text('×$count',
                  style: GoogleFonts.spaceGrotesk(
                      fontSize: 20,
                      fontWeight: FontWeight.w800,
                      color: count > 0 ? JarsColors.gold : JarsColors.textTertiary)),
              Text('trained',
                  style: GoogleFonts.inter(
                      fontSize: 9, color: JarsColors.textTertiary)),
            ]),
          ...
          Wrap(children: [
            stat('❤️ Health', '${spec.hp}'),
            stat('⚔️ Damage', '${spec.atk}'),
          ...
          Row(children: [
            Expanded(
              child: _btn('TRAIN · ⚡${spec.cost}',
                  g.active.resources >= spec.cost, () => train(1)),
            ),
            const SizedBox(width: 8),
            Expanded(
              child: _btn('×5 · ⚡${spec.cost * 5}',
                  g.active.resources >= spec.cost * 5, () => train(5)),
            ),
          ]),
        ],
      ),
